            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Thêm mới nơi đào tạo",
                    'content'=>'<span class="text-success">Thêm mới nơi đào tạo thành công</span>',
                    'footer'=> Html::button('Đóng',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                            Html::a('Thêm mới nơi đào tạo',['create'],['class'=>'btn btn-primary','role'=>'modal-remote'])
