...
use Yii;
use backend\models\Chuyennganh;
use backend\models\search\ChuyennganhSearch;
...
class ChuyennganhController extends Controller
{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Thêm mới chuyên ngành",
                    'content'=>'<span class="text-success">Create Chuyennganh success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Cập nhập chuyên ngành ".$model->tenchuyennganh,
                ...
                return [
                    'forceReload'=>'#crud-datatable-pjax',
                    'title'=> "Chuyên ngành ".$model->tenchuyennganh,
                    'content'=>$this->renderAjax('view', [
                        'model' => $model,
                    ]),
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing Chuyennganh model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Chuyennganh model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
