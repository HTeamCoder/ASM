            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Thêm mới nghiệp đoàn",
                    'content'=>'<span class="text-success">Thêm mới nghiệp đoàn thành công</span>',
                    'footer'=> Html::button('Đóng',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                            Html::a('Thêm mới nghiệp đoàn',['create'],['class'=>'btn btn-primary','role'=>'modal-remote'])
