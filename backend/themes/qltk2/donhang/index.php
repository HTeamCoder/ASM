...
/* @var $searchModel backend\models\search\DonhangSearch */
...
<div class="donhang-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> Thêm mới đơn hàng', ['create'],
                    ['role'=>'modal-remote','title'=> 'Thêm mới đơn hàng','class'=>'btn btn-default'])
                ],
            ],          
            'striped' => true,
            'condensed' => true,
