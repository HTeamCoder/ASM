...
<div class="nhommau-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> Thêm mới nhóm máu', ['create'],
                    ['role'=>'modal-remote','title'=> 'Thêm mới nhóm máu','class'=>'btn btn-default'])
                ],
            ],          
            'striped' => true,
            'condensed' => true,
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Danh sách nhóm máu',
