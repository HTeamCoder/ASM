...
class Donhang extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['ngayxuatcanh', 'ngayvevietnam','ngaychotcv'], 'safe'],
    ...
    {
        $this->ngaythi = myFuncs::convertDateSaveIntoDb($this->ngaythi);
        $this->ngayxuatcanh = myFuncs::convertDateSaveIntoDb($this->ngayxuatcanh);
        $this->ngayvevietnam = myFuncs::convertDateSaveIntoDb($this->ngayvevietnam);
        $this->ngaychotcv = myFuncs::convertDateSaveIntoDb($this->ngaychotcv);
